      ...
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <Link href="/"  className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            ...
            <p className="mt-2 mx-1 text-sm px-5  text-gray-500">wear the code &lt;code/&gt; </p> 
            <p className="mt-1 mx-1 text-sm px-5  text-gray-500" > Premium coding tshirts , hoodies and apparals</p>
          </div>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 Codeswear.com - All right reserved
